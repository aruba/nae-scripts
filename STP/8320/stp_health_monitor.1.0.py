...
class Agent(NAE):
    ...
    def __init__(self):
        uri1 = '/rest/v1/system/bridge/stp_instances/mstp/*?' \
               'attributes=topology_change_count'
        uri2 = '/rest/v1/system/bridge/stp_instances/mstp/*/' \
               'stp_instance_ports/*?attributes=statistics.BPDUs_Tx'
        uri3 = '/rest/v1/system/bridge/stp_instances/mstp/*/' \
               'stp_instance_ports/*?attributes=statistics.BPDUs_Rx'
        uri4 = '/rest/v1/system/bridge/stp_instances/mstp/*/' \
               'stp_instance_ports/*?attributes=port_role'
        uri5 = '/rest/v1/system/bridge/stp_instances/mstp/*/' \
               'stp_instance_ports/*?attributes=port_state'
        uri6 = '/rest/v1/system/bridge/stp_instances/mstp/*/' \
               'stp_instance_ports/*?attributes=port_inconsistent.loop_guard'
        uri7 = '/rest/v1/system/bridge/stp_instances/mstp/*/' \
               'stp_instance_ports/*?attributes=port_inconsistent.root_guard'
        uri8 = '/rest/v1/system/bridge/stp_instances/mstp/*/' \
