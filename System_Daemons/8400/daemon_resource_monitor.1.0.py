...
Manifest = {
    ...
    'Description': 'Top 5 System daemon CPU & Memory utilization '
                   'monitoring agent',
    'Version': '1.0',
...
ParameterDefinitions = {
    ...
    'daemon_name_5': {
        'Name': 'System daemon name 5',
        'Description': 'System daemon name 5 to monitor CPU and Memory '
                       'utilization',
        'Type': 'string',
        'Default': 'pimd'
    }
...
class Policy(NAE):
    ...
    def __init__(self):
        ...
        for i in range(1, 6):
            ...
            daemon_name_var = 'daemon_name_' + str(i)
            ...
            cpu_monitor = Monitor(
                cpu_uri,
                daemon_name + ' CPU (CPU/Memory utilization in %)',
            ...
            mem_uri = '/rest/v1/system/daemons/{}?' \
                      'attributes=resource_utilization.memory'
            mem_monitor = Monitor(
                mem_uri,
                daemon_name + ' Memory (CPU/Memory utilization in %)',
                [self.params[daemon_name_var]])
