...
Manifest = {
    'Name': 'routes_decrease_rate_monitor',
    'Description': 'Monitor rate of decrease of routes',
    'Version': '2.0',
    'Author': 'HPE Aruba Networking',
    'AOSCXVersionMin': '10.08',
    'AOSCXPlatformList': ['6200', '6300', '6400', '8320', '8325', '8400']
}
...
ParameterDefinitions = {
    ...
    'time_interval': {
        ...
        'Description': 'This parameter represents the time interval over '
                       'which the rate of decrease of routes count is'
                       'to be calculated.',
        'Type': 'Integer',
        'Default': 1
    }
...
class Agent(NAE):
    """
        ...
        decrease of routes count on the switch.
        The NAE script generates an alert whenever the rate of decrease of
        routes count on the switch over a time period of the time
    ...
    def __init__(self):
        ...
        # Get the initial routes count on the switch.
        initial_routes_count = self.get_resource_count()

        # Store the initial routes count so that it can be used in
        # calculating the rate of decrease of routes count.
    ...
    def create_agent_monitor(self):
        ...
        monitor = Monitor(Sum('/rest/v1/system/vrfs/*/routes?count'),
                          'routes count monitor')

        setattr(self, 'routes_count_monitor', monitor)
    ...
    def update_alert_level(self, decrease_rate, previous_count_value):
        ...
        if decrease_percentage > int(str(self.params[
            ...
            if self.get_alert_level() is None:
                ...
                message = 'The rate of decrease of the routes on ' \
    ...
    def get_resource_count(self):
        ...
        r = self.get_rest_request_json(
            HTTP_ADDRESS + '/rest/v10.08/system/vrfs/*/routes?count'
        )
        count = r.get("count", 0)
