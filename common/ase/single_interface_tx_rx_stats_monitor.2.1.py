...
Manifest = {
    ...
    'Description': 'Policy to monitor tx/rx packets stats of a interface using '
                   'multi-graph',
    'Version': '2.1',
...
class Agent(NAE):
    ...
    def __init__(self):
        ...
        rate_m1 = Rate(uri1, "20 seconds", [self.params['interface_id']])
        self.m1 = Monitor(
            rate_m1,
        ...
        rate_m3 = Rate(uri3, "20 seconds", [self.params['interface_id']])
        self.m3 = Monitor(
            rate_m3,
