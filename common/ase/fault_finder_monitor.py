...
class Agent(NAE):
    ...
    def __init__(self):
        ...
        # Undersize packets
        uri2 = '/rest/v1/system/interfaces/*?attributes=statistics.ethernet_stats_undersize_packets&filter=type:system'
        undersize_uri = Rate(uri2, '60 seconds')
        self.m2 = Monitor(
            undersize_uri, 'Rate of interface ethernet stats undersize packets (packets/s)')

        # Good frames
        uri3 = '/rest/v1/system/interfaces/*?attributes=statistics.ethernet_stats_rx_no_errors&filter=type:system'
        good_frames_uri = Rate(uri3, '20 seconds')
        self.m3 = Monitor(
            good_frames_uri, 'Rate of interface good frames (packets/s)')

        # Link resets
        uri4 = '/rest/v1/system/interfaces/*?attributes=link_resets&filter=type:system'
        rate_uri = Rate(uri4, '10 seconds')
        self.m4 = Monitor(
            rate_uri, 'Interface Link Resets Rate (link resets/s)')

        # Rx CRC errors
        uri5 = '/rest/v1/system/interfaces/*?attributes=statistics.rx_crc_err&filter=type:system'
        ...
        uri6 = '/rest/v1/system/interfaces/*?attributes=statistics.ethernet_stats_fragments&filter=type:system'
        ...
        # Collision
        uri7 = '/rest/v1/system/interfaces/*?attributes=statistics.collisions&filter=type:system'
        collisions_uri = Rate(uri7, '20 seconds')
        self.m7 = Monitor(collisions_uri,
                          'Rate of collision packets (packets/s)')
        # Over bandwidth
        uri8 = '/rest/v1/system/interfaces/*?attributes=statistics.tx_dropped&filter=type:system'
        tx_drop_uri = Rate(uri8, '20 seconds')
        self.m8 = Monitor(tx_drop_uri,
                          'Rate of tx drop packets (packets/s)')

        # Good frames(tx_no_errors)
        uri9 = '/rest/v1/system/interfaces/*?attributes=statistics.ethernet_stats_tx_no_errors&filter=type:system'
